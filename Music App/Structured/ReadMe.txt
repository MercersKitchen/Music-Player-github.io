...
. Building a boilerplate
  - Static: size, variables for parameters, functions (simplifies coding expectations and visually completes algorithms)
    - Static Programs, very simple prototyping examples
